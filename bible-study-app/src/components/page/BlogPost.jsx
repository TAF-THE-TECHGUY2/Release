...
const BlogPost = () => {
  ...
  // Split description into paragraphs every 40 words
  ...
  return (
    <Box sx={{ background: "#3f593e", color: "white", py: 4 }}>
      <Container>
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 2 }}>
          ...
          <Typography fontWeight="medium">Michelle-Irene</Typography>
        ...
        <Typography fontWeight="bold" mt={3}>
          Scripture Reading: 1 Kings 20:23-25, 38-40; Matthew 28:20
        </Typography>
      </Container>
    </Box>
  );
